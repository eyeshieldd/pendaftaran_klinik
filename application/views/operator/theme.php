...
<html lang="en" class="no-focus">
    ...
    <body class="">
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-classic sidebar-inverse">
            <nav id="sidebar">
                <!-- Sidebar Content -->
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a class="link-effect font-w700" href="index.html">
                                    ...
                                    <span class="font-size-xl text-dual-primary-dark">Smart</span><span class="font-size-xl text-primary">hospital</span>
                                </a>
                            </div>
                            <!-- END Logo -->
                        </div>
        ...
        <script type="text/javascript">
         ...
         <?php
            echo isset($FILE_JS) && !empty($FILE_JS) ? $FILE_JS : '';
